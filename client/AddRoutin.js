        ...
        <SafeAreaView edges={[ 'top', 'bottom']} style={{ flex: 1, backgroundColor: '#F5F1E9'}}>
            <ScrollView style={{ flex: 1, backgroundColor: routie_01}} stickyHeaderIndices={[0]}>
                ...
                <View style={{paddingHorizontal: 20, paddingVertical: 12}}>
                    <Text style={{fontFamily: 'Pretendard_ExtraBold', fontSize: 16, color: routie_07, paddingVertical: 10}}>카테고리</Text>
                    <ScrollView style={{marginBottom: 22}} horizontal showsHorizontalScrollIndicator={false}>
                        {categories.map((category, index) => (
                            <TouchableOpacity
                                ...
                                styles.categoryTab,
                                {
                                    backgroundColor: selectedCategory === category ? '#FF622A' : '#F5F1E9',
